...
// repeat until smaller than both
	...
	printf("calling isIn(t,u) on getIndex(u)=%d\n", getIndex(t, u));
	if (isIn(t, u)) {
		printf("isIn(t, u) = true\n"); // TODO: problem here. this should fire but it did not
		printf("calling isIn(t,l) on getIndex(l)=%d\n", getIndex(t, l));
		if (isIn(t, l)) {
			printf("isIn(t, l) = true\n");
		// can look u/l
...
int main() {
	...
	tableau *t = getNewTableau(2,2);
	insert(t, 1);
	printf("insert(1) complete -------------------------;\n");
	printTableau(t);
	insert(t, 1);
	printf("insert(1) complete -------------------------;\n");
	printTableau(t);
	insert(t, 2);
	printf("insert(2) complete -------------------------;\n");
	printTableau(t);
